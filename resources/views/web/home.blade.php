...
@section('content')
    <div class="content-margins grey">
        <div class="slider-wrapper">
            ...
            <div class="swiper-container" data-parallax="1" data-auto-height="1">
                <div class="swiper-wrapper">
                    <div class="swiper-slide" style="background-image: url({{asset("assets/img/background-1.jpg")}});">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="cell-view page-height">
                                        ...
                                        <div data-swiper-parallax-x="-300">
                                            <div class="buttons-wrapper">
                                                ...
                                                <a class="button size-2 style-1" href="{{route('web.detail')}}">
                                                    <span class="button-wrapper">
                                                        <span class="icon"><img src="{{asset("assets/img/icon-1.png")}}"
                                                                alt=""></span>
                                                ...
                                                <a class="button size-2 style-2" href="{{route('web.detail')}}">
                                                    <span class="button-wrapper">
                                                        <span class="icon"><img src="{{asset("assets/img/icon-2.png")}}"
                                                                alt=""></span>
                            ...
                            <div class="slider-product-preview" data-swiper-parallax-x="-600">
                                <img src="{{asset("assets/img/product-preview-12.png")}}" alt="" />
                            </div>
                            <div class="empty-space col-xs-b80 col-sm-b0"></div>
                        </div>
                    </div>
                    <div class="swiper-slide" style="background-image: url({{asset("assets/img/background-2.jpg")}});">
                        <div class="container">
                            <div class="row">
                            ...
                            <div class="slider-product-preview align-left" data-swiper-parallax-x="-600">
                                <img src="{{asset("assets/img/product-preview-13.png")}}" alt="" />
                            </div>
                            <div class="empty-space col-xs-b80 col-sm-b0"></div>
                        </div>
                    </div>
                    <div class="swiper-slide" style="background-image: url({{asset("assets/img/background-3.jpg")}});">
                        <div class="container">
                            <div class="row">
        ...
        <div class="row nopadding">
            <div class="col-sm-6">
                <div class="banner-shortcode style-3 wide"
                    style="background-image: url({{asset("assets/img/background-9.jpg")}});">
                    <div class="valign-middle-cell">
                        <div class="valign-middle-content">
                            ...
                            <div class="simple-article size-4 light transparent col-xs-b30">Lorem ipsum dolor sit amet,
                                consectetur adipiscing elit. Praesentir pulvinar ante et nisl scelerisque.</div>
                            <a class="button size-2 style-1" href="{{route('web.detail')}}">
                                <span class="button-wrapper">
            ...
            <div class="col-sm-6">
                <div class="banner-shortcode style-3 wide"
                    style="background-image: url({{asset("assets/img/background-10.jpg")}});">
                    <div class="valign-middle-cell">
                        <div class="valign-middle-content">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="product-shortcode style-1 big">
                            ...
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-62.jpg') }}" alt="">
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        ...
                                        <a class="button size-2 style-3"  href="{{route('web.detail')}}">
                                            <span class="button-wrapper">
                                                <span class="icon"><img src="{{ asset('assets/img/icon-3.png') }}"
                                                        alt=""></span>
                                                <span class="text">Add To Cart</span>
                                            </span>
                                        </a>
                            ...
                            <div class="description">
                                <div class="simple-article text size-2">Mollis nec consequat at In feugiat molestie tortor a
                                    malesuada etiam a venenatis ipsum</div>
                                <div class="icons">
                    ...
                    <div class="swiper-slide">
                        <div class="product-shortcode style-1 big">
                            ...
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-63.jpg') }}" alt="">
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-2 style-2" href="{{route('web.detail')}}">
                                            <span class="button-wrapper">
                            ...
                            <div class="price">
                                ...
                                <div class="simple-article size-4"><span class="color">$155.00</span>&nbsp;&nbsp;&nbsp;<span
                    ...
                    <div class="swiper-slide">
                        <div class="product-shortcode style-1 big">
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-64.jpg') }}" alt="">
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-2 style-2" href="{{route('web.detail')}}">
                                            <span class="button-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="product-shortcode style-1 big">
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-65.jpg') }}" alt="">
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-2 style-2" href="{{route('web.detail')}}">
                                            <span class="button-wrapper">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="container">
                            <div class="row vertical-aligned-columns">
                                <div class="col-sm-6 col-xs-b30 col-sm-b0">
                                    <img src="{{ asset('assets/img/thumbnail-24.jpg') }}" class="block-image rounded-image"
                                        alt="" />
                                </div>
                                <div class="col-sm-6 col-md-4 col-md-offset-2">
                                    ...
                                    <div class="buttons-wrapper">
                                        <a class="button size-2 style-3"  href="{{route('web.detail')}}">
                                            <span class="button-wrapper">
                                                <span class="icon"><img src="{{ asset('assets/img/icon-4.png') }}"
                                                        alt=""></span>
                                                <span class="text">Learn More</span>
                                            </span>
                                        </a>
                        ...
                        <div class="aligned-middle-image-shortcode hidden-xs hidden-sm" data-swiper-parallax-x="-600">
                            <img src="{{ asset('assets/img/thumbnail-25.png') }}" alt="" />
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="container">
            ...
            <div class="tab-entry visible">
                <div class="slider-wrapper side-borders">
                    ...
                    <div class="swiper-container" data-breakpoints="1" data-xs-slides="1" data-sm-slides="2"
                        data-md-slides="3" data-lt-slides="4" data-slides-per-view="5">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="product-shortcode style-5 small">
                                    ...
                                    <div class="preview">
                                        <div class="swiper-container" data-loop="1" data-touch="0">
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <img src="{{ asset('assets/img/product-66.jpg') }}" alt="" />
                                                </div>
                                                <div class="swiper-slide">
                                                    <img src="{{ asset('assets/img/product-67.jpg') }}" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="title">
                                        <div class="simple-article size-1 color col-xs-b5"><a href="#">Modern edition</a>
                                        </div>
                                        <div class="h6 animate-to-green"><a href="#">modern beat nine</a></div>
                                    </div>
                                    <div class="description">
                                        <div class="simple-article text size-2">Mollis nec consequat at In feugiat molestie
                            ...
                            <div class="swiper-slide">
                                <div class="product-shortcode style-5 small">
                                    ...
                                    <div class="preview">
                                        <div class="swiper-container" data-loop="1" data-touch="0">
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img src="{{ asset('assets/img/product-68.jpg') }}" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="price">
                                        <div class="simple-article size-4 dark"><span
                                                class="color">$155.00</span>&nbsp;&nbsp;&nbsp;<span
                                                class="line-through">$350.00</span></div>
                                    </div>
                                    ...
                                    <div class="preview">
                                        <div class="swiper-container" data-loop="1" data-touch="0">
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img src="{{ asset('assets/img/product-69.jpg') }}" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="preview">
                                        <div class="swiper-container" data-loop="1" data-touch="0">
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img src="{{ asset('assets/img/product-70.jpg') }}" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-6 col-xs-b30 col-sm-b0">
                                    <div class="banner-shortcode style-3 rounded-image"
                                        style="background-image: url({{asset("assets/img/thumbnail-28.jpg")}});">
                                        <div class="valign-middle-cell">
                                            <div class="valign-middle-content">
                                                <div class="simple-article size-5 light transparent uppercase col-xs-b5">
                                                    starting from <span class="light">$95.00</span></div>
                                                <h3 class="h3 light col-xs-b15">sound<span class="color">max</span> series
                                                </h3>
                                                <div class="simple-article size-3 light transparent col-xs-b30">Lorem ipsum
                                                    dolor sit amet, consectetur adipiscing elit. Praesentir pulvinar ante et
                                                    nisl scelerisque. Mauris dignissim metus mollis neque rhoncus in nunc
                                                    sit amet </div>
                                                <a class="button size-2 style-1" href="{{route('web.detail')}}">
                                                    <span class="button-wrapper">
                                                        <span class="icon"><img src="{{ asset('assets/img/icon-1.png') }}"
                                ...
                                <div class="col-sm-3 col-xs-b30 col-sm-b0">
                                    <div class="product-shortcode style-8">
                                        <a class="preview" href="#">
                                            <img src="{{ asset('assets/img/thumbnail-26.jpg') }}" alt="" />
                                            <img src="{{ asset('assets/img/product-132.jpg') }}" alt="" />
                                        </a>
                                        <div class="content">
                                            <div class="title">
                                            ...
                                            <div class="description">
                                                <div class="simple-article size-2">Quisque rhoncus orci vitae nisl rutrum
                                                    rutrum lesuada</div>
                                            </div>
                                            <div class="price">
                                ...
                                <div class="col-sm-3">
                                    <div class="product-shortcode style-8">
                                        <a class="preview" href="#">
                                            <img src="{{ asset('assets/img/thumbnail-27.jpg') }}" alt="" />
                                            <img src="{{ asset('assets/img/product-132.jpg') }}" alt="" />
                                        </a>
                                        <div class="content">
                                            <div class="title">
        ...
        <div class="slider-wrapper">
            ...
            <div class="swiper-container" data-parallax="1" data-auto-height="1">
                <div class="swiper-wrapper">
                    <div class="swiper-slide" style="background-image: url({{asset("assets/img/background-4.jpg")}});">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-6 col-sm-offset-6">
                                    <div class="cell-view simple-banner-height">
                                        ...
                                        <div data-swiper-parallax-x="-400">
                                            <div class="simple-article size-4 light transparent">
                                                <p>Praesent nec finibus massa. Phasellus id auctor lacus, at iaculis lorem.
                                                    Donec quis arcu elit. In vehicula purus sem, eu mattis est lacinia.</p>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <ul>
                                                            <li>20.000h of high quality music</li>
                                ...
                                <div class="product-preview-shortcode light">
                                    <div class="preview">
                                        ...
                                        <div class="entry full-size swiper-lazy active"
                                            data-background="img/product-preview-14.png"></div>
                                        <div class="entry full-size swiper-lazy"
                                            data-background="img/product-preview-13.png"></div>
                                        <div class="entry full-size swiper-lazy"
                                            data-background="img/product-preview-12.png"></div>
                                    </div>
                                    <div class="sidebar valign-middle" data-swiper-parallax-x="-300">
                                        <div class="valign-middle-content">
                                            <div class="entry active"><img src="{{ asset('assets/img/product-71.png') }}"
                                                    alt="" /></div>
                                            <div class="entry"><img src="{{ asset('assets/img/product-72.png') }}" alt="" />
                                            </div>
                                            <div class="entry"><img src="{{ asset('assets/img/product-73.png') }}" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row nopadding">
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-74.jpg') }}" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-75.jpg') }}" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="product-label red">20% discount</div>
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-76.jpg') }}" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-77.jpg') }}" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-78.jpg') }}" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-79.jpg') }}" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-80.jpg') }}" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-81.jpg') }}" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="product-label green">Best Price</div>
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-82.jpg') }}" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-83.jpg') }}" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-84.jpg') }}" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="{{ asset('assets/img/product-85.jpg') }}" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
            ...
            <div class="row">
                <div class="col-md-4 col-xs-b15 col-md-b0">
                    <div class="banner-shortcode style-4 rounded-image text-center"
                        style="background-image: url({{asset("assets/img/background-5.jpg")}});">
                        <div class="valign-middle-cell">
                            <div class="valign-middle-content">
                ...
                <div class="col-md-4 col-xs-b15 col-md-b0">
                    <div class="banner-shortcode style-4 rounded-image text-center"
                        style="background-image: url({{asset("assets/img/background-6.jpg")}});">
                        <div class="valign-middle-cell">
                            <div class="valign-middle-content">
                ...
                <div class="col-md-4 col-xs-b15 col-md-b0">
                    <div class="banner-shortcode style-4 rounded-image text-center"
                        style="background-image: url({{asset("assets/img/background-7.jpg")}});">
                        <div class="valign-middle-cell">
                            <div class="valign-middle-content">
        ...
        <div class="container">
            ...
            <div class="row-background left hidden-xs">
                <img src="{{ asset('assets/img/background-8.jpg') }}" alt="" />
            </div>
        </div>
    </div>
@endsection