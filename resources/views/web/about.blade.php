...
@section('content')
    <div class="block-entry fixed-background" style="background-image: url({{asset("assets/img/background-24.jpg")}});">
        <div class="container">
            <div class="row">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="icon-description-shortcode style-2">
                            <img class="image-icon image-thumbnail rounded-image" src="{{ asset('assets/img/thumbnail-35.jpg') }}" alt="" />
                            <div class="content">
                    ...
                    <div class="swiper-slide">
                        <div class="icon-description-shortcode style-2">
                            <img class="image-icon image-thumbnail rounded-image" src="{{ asset('assets/img/thumbnail-36.jpg') }}" alt="" />
                            <div class="content">
                    ...
                    <div class="swiper-slide">
                        <div class="icon-description-shortcode style-2">
                            <img class="image-icon image-thumbnail rounded-image" src="{{ asset('assets/img/thumbnail-37.jpg') }}" alt="" />
                            <div class="content">
    ...
    <div class="container">
        <div class="slider-wrapper our-team-slider">
            ...
            <div class="swiper-container" data-breakpoints="1" data-xs-slides="1" data-sm-slides="2" data-md-slides="3"
                data-lt-slides="4" data-slides-per-view="4">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="product-shortcode style-9">
                            <div class="preview">
                                <img src="{{ asset('assets/img/thumbnail-40.jpg') }}" alt="" />
                            </div>
                            <div class="content">
                                <div class="title">
                    ...
                    <div class="swiper-slide">
                        <div class="product-shortcode style-9">
                            <div class="preview">
                                <img src="{{ asset('assets/img/thumbnail-41.jpg') }}" alt="" />
                            </div>
                            <div class="content">
                                <div class="title">
                    ...
                    <div class="swiper-slide">
                        <div class="product-shortcode style-9">
                            <div class="preview">
                                <img src="{{ asset('assets/img/thumbnail-42.jpg') }}" alt="" />
                            </div>
                            <div class="content">
                                <div class="title">
                    ...
                    <div class="swiper-slide">
                        <div class="product-shortcode style-9">
                            <div class="preview">
                                <img src="{{ asset('assets/img/thumbnail-43.jpg') }}" alt="" />
                            </div>
                            <div class="content">
                                <div class="title">
                                    <div class="simple-article size-1 uppercase color col-xs-b5">co-founder</div>
    ...
    <div class="container">
        <a class="client-logo-entry">
            <img src="{{ asset('assets/img/client-logo-1.jpg') }}" alt="" />
            <img src="{{ asset('assets/img/client-logo-1.jpg') }}" alt="" />
        </a>
        <a class="client-logo-entry">
            <img src="{{ asset('assets/img/client-logo-2.jpg') }}" alt="" />
            <img src="{{ asset('assets/img/client-logo-2.jpg') }}" alt="" />
        </a>
        <a class="client-logo-entry">
            <img src="{{ asset('assets/img/client-logo-3.jpg') }}" alt="" />
            <img src="{{ asset('assets/img/client-logo-3.jpg') }}" alt="" />
        </a>
        <a class="client-logo-entry">
            <img src="{{ asset('assets/img/client-logo-4.jpg') }}" alt="" />
            <img src="{{ asset('assets/img/client-logo-4.jpg') }}" alt="" />
        </a>
        <a class="client-logo-entry">
            <img src="{{ asset('assets/img/client-logo-5.jpg') }}" alt="" />
            <img src="{{ asset('assets/img/client-logo-5.jpg') }}" alt="" />
        </a>
        <a class="client-logo-entry">
            <img src="{{ asset('assets/img/client-logo-6.jpg') }}" alt="" />
            <img src="{{ asset('assets/img/client-logo-6.jpg') }}" alt="" />
        </a>
        <a class="client-logo-entry">
            <img src="{{ asset('assets/img/client-logo-7.jpg') }}" alt="" />
            <img src="{{ asset('assets/img/client-logo-7.jpg') }}" alt="" />
        </a>
        <a class="client-logo-entry">
            <img src="{{ asset('assets/img/client-logo-8.jpg') }}" alt="" />
            <img src="{{ asset('assets/img/client-logo-8.jpg') }}" alt="" />
        </a>
        <a class="client-logo-entry">
            <img src="{{ asset('assets/img/client-logo-9.jpg') }}" alt="" />
            <img src="{{ asset('assets/img/client-logo-9.jpg') }}" alt="" />
        </a>
        <a class="client-logo-entry">
            <img src="{{ asset('assets/img/client-logo-10.jpg') }}" alt="" />
            <img src="{{ asset('assets/img/client-logo-10.jpg') }}" alt="" />
        </a>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-6">
                <div class="cell-view simple-banner-height big">
                    ...
                    <div class="title-underline left"><span></span></div>
                    <div class="simple-article size-4 grey">In feugiat molestie tortor a malesuada. Etiam a venenatis ipsum.
                        Proin pharetra elit at feugiat commodo vel placerat tincidunt sapien nec</div>
                    <div class="empty-space col-xs-b30 col-sm-b70"></div>
                    <div class="icon-description-shortcode style-3">
                        <div class="image-icon">
                            <img class="image-thumbnail rounded-image" src="{{ asset('assets/img/thumbnail-38.jpg') }}" alt="" />
                        </div>
                        <div class="content">
                            <div class="cell-view">
                                <h6 class="title h6">Phasellus rhoncus in nunc sit</h6>
                    ...
                    <div class="icon-description-shortcode style-3">
                        <div class="image-icon">
                            <img class="image-thumbnail rounded-image" src="{{ asset('assets/img/thumbnail-39.jpg') }}" alt="" />
                        </div>
                        <div class="content">
                            <div class="cell-view">
                                <h6 class="title h6">Phasellus rhoncus in nunc sit</h6>
        ...
        <div class="row-background left hidden-xs hidden-sm">
            <img src="{{ asset('assets/img/background-25.jpg') }}" alt="" />
        </div>
    </div>
@endsection